...
from deps import db, get_current_user, require_manager, _audit, get_campus_filter, get_role_level, is_system_admin, logger
            ...
            if prod.get("event_id"):
                ...
                for _ in range(max(1, qty)):
                    ticket = {
                        ...
                        "holder_person_id": doc.get("customer_id"),
                        "holder_email": (doc.get("customer_email") or "").strip().lower() or None,
                        "event_title": prod.get("name") or "",
