...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://comms-hub-57.preview.emergentagent.com')
...
class TestAdminUserManagement:
    ...
    def test_reset_password(self, auth_headers):
        ...
        response = requests.post(
            ...
            json={"new_password": os.environ.get("TEST_ADMIN_PASSWORD", "Admin@1234")},  # Reset to original
