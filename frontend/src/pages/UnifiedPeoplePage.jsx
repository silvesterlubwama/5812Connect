                  ...
                  <CardContent className="p-3 flex items-center gap-3">
                    ...
                    {isCoordinator && (
                      <div className="flex gap-1" onClick={e => e.stopPropagation()}>
                        ...
                        {canEditStaff && m.user_id && <a href={`/admin?user=${m.user_id}`} className="inline-flex items-center justify-center h-7 w-7 p-0 rounded-md hover:bg-accent text-purple-600" title="Full Admin Edit" onClick={e => e.stopPropagation()}><Shield size={13} /></a>}
